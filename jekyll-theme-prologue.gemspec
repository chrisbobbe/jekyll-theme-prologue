...
Gem::Specification.new do |spec|
  ...
  spec.version       = "0.3.2"
  spec.authors       = ["HTML5 UP", "Tushar Sharma"]
  spec.email         = ["tusharsharmavj@gmail.com"]

  spec.summary       = %q{A Jekyll version of the Prologue theme by HTML5 UP.}
  spec.description   = "A Jekyll version of the Prologue theme by HTML5 UP. Demo: https://github.com/tusharxsharma/Prologue"
  spec.homepage      = "https://github.com/tusharxsharma/Portfolio"
