...
This is Prologue, a simple, single page responsive site template from [HTML5 UP](https://html5up.net/prologue), now available as a blog-aware Jekyll theme from [Tushar Sharma](https://github.com/tusharxsharma). It features a clean, minimalistic design and a sticky sidebar with navigation-linked scrolling.

**Demo**: https://tusharxsharma.github.io/Portfolio
...
2. **Fork or clone the [GitHub repository](https://github.com/tusharxsharma/Portfolio).** If you want to use [GitHub Pages](https://pages.github.com/), create a branch named `gh-pages`, and replace `theme: jekyll-theme-prologue` with `remote_theme: tusharxsharma/jekyll-theme-prologue` in the provided `_config.yml` ([GitHub Pages now supports open-source themes on GitHub](https://github.com/blog/2464-use-any-theme-with-github-pages)).
...
To add a page, just make a new .html or .md file in your project directory. There's an example called `reading-list` [provided](https://github.com/tusharxsharma/Portfolio/blob/master/reading-list.md) with the GitHub repository. Add this frontmatter:
